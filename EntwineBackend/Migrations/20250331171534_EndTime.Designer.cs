...
namespace EntwineBackend.Migrations
{
    ...
    [Migration("20250331171534_EndTime")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntwineBackend.DbItems.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Community", "StartTime");
            ...
            modelBuilder.Entity("EntwineBackend.DbItems.CommunityChatMessage", b =>
                {
                    b.HasOne("EntwineBackend.DbItems.ProfileData", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("EntwineBackend.DbItems.ProfileData", b =>
                {
                    b.HasOne("EntwineBackend.DbItems.Location", "Location")
                        .WithMany()

...
--
-- Name: IX_Events_Community_Start; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_Events_Community_Start" ON public."Events" USING btree ("Community", "Start");

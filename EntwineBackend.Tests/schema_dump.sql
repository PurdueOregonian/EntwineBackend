...
--
-- Name: IX_Events_Community_Time; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_Events_Community_Time" ON public."Events" USING btree ("Community", "Time");

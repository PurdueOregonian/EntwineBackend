...
CREATE TABLE public."Events" (
    ...
    "EndTime" timestamp with time zone DEFAULT '-infinity'::timestamp with time zone NOT NULL
);
...
--
-- Name: IX_Events_Community_StartTime; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_Events_Community_StartTime" ON public."Events" USING btree ("Community", "StartTime");
